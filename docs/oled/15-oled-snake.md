...
## Circuit Diagram
The SPI has seven wires and there are four buttons.

Here is some code that defines these inputs:
...
The full source is here: [source](https://github.com/CoderDojoTC/micropython/tree/main/src/oled/spi/oled-spi-snake.py)
